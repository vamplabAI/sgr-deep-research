...
| **4. SGRAutoToolCallingAgent** | FC Tool optional   | ✅ At model's choice | 7 (6 + ReasoningTool) | 1–2          | FC "auto"            |
| **5. SGRSOToolCallingAgent**   | FC → SO → FC auto  | ✅ FC enforced       | 7 (6 + ReasoningTool) | 3            | FC → SO → FC auto    |
