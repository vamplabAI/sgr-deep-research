...
export interface TranscriptionProgression {
  step: string
  description: string
...
export interface TranscriptionStatusResponse {
  task_id: string
  status: 'pending' | 'processing' | 'completed' | 'failed'
  progression: TranscriptionProgression
  error: string | null
  created_at: string
...
export interface TranscriptionConfig {
  ...
  diarize: boolean
  diarize_speakers_num: number | null
}
...
export interface TranscriptionSharingOptions {
  mode: 'private' | 'public'
...
export interface TranscriptionResultResponse {
  ...
  duration: number
  summary: string | null
  sharing_options: TranscriptionSharingOptions
}
