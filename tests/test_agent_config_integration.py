...
including settings loading, MCP integration, and environment-based setup.
"""
...
from sgr_deep_research.settings import get_config, AppConfig, OpenAIConfig
...
class TestAgentConfigurationIntegration:
    ...
    def test_mcp_integration_in_agents(self):
        ...
        with patch("sgr_deep_research.core.base_agent.get_config") as mock_get_config, \
            ...
            mock_config.mcp.transport_config = {
                "mcpServers": {
                    "test_server": {"url": "https://test-mcp.example.com"}
                }
            }
...
class TestAgentConfigurationPerformance:
    ...
    def test_config_loading_performance(self):
        """Test that config loading doesn't significantly impact agent creation."""
        import time
