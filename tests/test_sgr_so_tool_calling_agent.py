...
This module contains comprehensive tests for the SGRSOToolCallingAgent
class, including initialization, structured output handling, and
execution flow.
"""
...
class TestSGRSOToolCallingAgentInitialization:
    ...
    def test_initialization_with_custom_params(self, mock_openai, mock_get_config):
        ...
        agent = SGRSOToolCallingAgent(task="Custom task", max_clarifications=5, max_iterations=15, max_searches=8)
